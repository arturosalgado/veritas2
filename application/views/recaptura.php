                ...
                <input type="hidden" name="idprod" value="<?= $produccion['idproduccion'] ?>" />
                 <div data-role="fieldcontain">
                        <fieldset data-role="controlgroup">
                            ...
                            <input name="motivo" id="textinput0" placeholder="" value="" type="text" required />
                        </fieldset>
                    </div>
                <div data-role="fieldcontain">
                        <fieldset data-role="controlgroup">
                    ...
                    <div data-role="fieldcontain">
                        <fieldset data-role="controlgroup">
                            ...
                            <input name="horas_laboradas" id="textinput2" placeholder="" value="8" type="number" required max="8"/>
                        </fieldset>
                    </div>
